...
## Запуск додатку з PostgreSQL через Docker

1. Запустити файл `docker-compose.yml` для створення контейнера PostgreSQL:


 ### docker-compose up -d

Запустити додаток зі специфічними налаштуваннями для PostgreSQL:

### mvn spring-boot:run -Dspring-boot.run.profiles=prod


За замовчуванням додаток використовує налаштування під H2 базу, тому для підключення до PostgreSQL потрібно явно вказати профіль prod.

## swagger http://localhost:8080/swagger-ui/index.html
## **Base URL:** `http://localhost:8080/api`
### Автори доступні одразу. Для того, щоб перевірити книги, спочатку треба додати їх з upload.json, який знаходиться на одному рівні з файлом README.
